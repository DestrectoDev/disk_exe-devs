...
class Character extends FNFSprite
{
	...
	public var iconColor:FlxColor = 0xFFFF0000;
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'bffurry':
				...
				animation.addByPrefix('singUPmiss', 'upM', 24, false);
			...
			case 'bffurry-dead':
				...
				playAnim('firstDeath');
			case 'gf-furry':
				tex = Paths.getSparrowAtlas('characters/gf/Gf_furra');
				frames = tex;
	...
	function loadOffsetFile() {
		if (OpenFlAssets.exists(Paths.offsetTxt(curCharacter + 'Offsets')))
		{
			var offset:Array<String> = CoolUtil.coolTextFile(Paths.offsetTxt(curCharacter + "Offsets"));
